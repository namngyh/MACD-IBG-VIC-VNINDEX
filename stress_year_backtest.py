#!/usr/bin/env python3
"""
Backtest Ito Bayes-GARCH, MACD, and Buy & Hold during the most volatile asset years.

The script identifies stress years from benchmark asset returns, then resets
...
def plot_year_ranking(ranking: pd.DataFrame, selected_years: list[int], output_dir: Path) -> None:
    ...
    ax.set_title("Most Difficult Asset Years by Composite Stress Score")
